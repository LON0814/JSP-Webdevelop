...
%>
 <%@ include file="../../common/include/jsp_sql_dbget_rud.txt" %>
<%
  // 회원 검색정보 출력
%>
...
<form name="customer_form" method="post" action="customer_update_db.jsp">
 <table>
  ...
  <tr>
   <th><span class="mag_red">*</span>전화번호</th>
...
%>
       ...
       <input type="text" name="tel_no_seq" size="5" maxlength="4" value="<%=cust_tel_no[2]%>" style="ime-mode:disabled" required>
   </td>
  </tr>
  <tr>
    <th><span class="msg_red">*</span> 주 &nbsp; 소 &nbsp; &nbsp;</th>
    <td><input type="text" name="cust_addr" size="50" maxlength="50" value="<%=cust_addr%>" style="ime-mode:activce" required></td>
  </tr>
  <tr>
    <th>성 &nbsp; 별 &nbsp;</th>
    <td>
